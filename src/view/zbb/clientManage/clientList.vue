                    ...
                    axios
                        .request({
                            ...
                            data: {
                                ...
                                //dy
                                dy_subscribe: this.formInline.dy_subscribe===''?this.DY_MERCHANT_FOLLOW:this.formInline.dy_subscribe,
                                ...
                                //tt
                                tt_subscribe: this.formInline.tt_subscribe===''?this.TT_MERCHANT_FOLLOW:this.formInline.tt_subscribe,
