                        ...
                        <i-col span='10'>
                            <FormItem prop="type1">
                                <Select v-model="searchData.type1">
                                    <Option value="master_username">变动人账号</Option>
                                    <Option value="master_id">变动人ID</Option>
                                </Select>
                            </FormItem>
                        </i-col>
                        <i-col span='14'>
        ...
        return {
            ...
            column: [
                ...
                },
                {
                    title: "变动人账号",
                    render: (h, params) => {
                        return h("p", params.row.master?params.row.master.username:'');
                    }
                }
            ],
            list: []
    ...
    methods: {
        ...
        getList() {
            axios
                .request({
                    url:
                        "finance/masters/fund/show?pagesize=" +
                        this.per_page +
                        "&page=" +
                        this.currentPage,
                    method: "post",
        ...
        returnExcel() {
            ...
            axios.request({
                ...
                token = res.data
                let url =
                "https://www.iryi.cn/backend/finance/masters/fund/export?" +
                "master_username=" +
                (this.searchData.type1 === "master_username"
                    ? this.searchData.type1Text
                    : "") +
