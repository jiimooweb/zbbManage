...
export default {
    ...
    methods: {
        getList() {
            axios
                .request({
                    url: "finance/apprentices/fund/show?pagesize="+this.per_page+"&page="+this.currentPage,
                    method: "post",
                    data: {
                        apprentice_username: (this.searchData.type1==='apprentices_username'?this.searchData.type1Text:''),
                        apprentice_id: (this.searchData.type1==='apprentices_id'?this.searchData.type1Text:''),
        ...
        returnExcel() {
            let url =
                ("http://120.79.203.214/zbb/public/backend/finance/apprentices/fund/export?" +
                    "apprentice_username="+(this.searchData.type1 === "apprentice_username" ? this.searchData.type1Text : "") +
                    "&apprentice_id=" + (this.searchData.type1 === "apprentice_id" ? this.searchData.type1Text : "") +
                    "&type=" + (this.searchData.type === -1 ? "" : this.searchData.type) +
                    "&change_fund=" + this.searchData.change_fund +
                    "&symbol_c=" + this.searchData.symbol_c +
                    "&result_fund=" + this.searchData.result_fund +
