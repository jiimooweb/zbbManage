<template>
    <div class="MASTERWITHDRAW">
        ...
        <row :style='"width:100%;margin-bottom:10px;display:" + (this.hasPower(this.$store.state.user.access,"masterWithdraw-review")? "inline-block;": "none;")'>
            <i-col span='10'>
...
export default {
    ...
    watch: {
        getAccess: function(a, b) {
            isShowColumn(a, ["masterWithdraw-review"], this.column);
        }
    },
    methods: {
        returnExcel(){
            ...
            axios.request({
                ...
                token = res.data
                let url = 'https://www.iryi.cn/backend/finance/masters/export?' + ("&username=" +
